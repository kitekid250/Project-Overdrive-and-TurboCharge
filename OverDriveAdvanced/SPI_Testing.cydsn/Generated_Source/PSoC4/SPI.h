...
#if(SPI_CY_SCBIP_V1)
    #define SPI_CY_SCBIP_V1_I2C_ONLY   (1u) /* SCB IP V1 supports only I2C */
#else
    #define SPI_CY_SCBIP_V1_I2C_ONLY   (0u) /* SCB IP V0 supports I2C, SPI, UART */
...
#define SPI_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPI_TX_FIFO_STATUS_RD_PTR_POS)
#define SPI_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPI_TX_FIFO_STATUS_WR_PTR_POS)
...
#define SPI_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) 0x07u << SPI_RX_FIFO_STATUS_RD_PTR_POS)
#define SPI_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) 0x07u << SPI_RX_FIFO_STATUS_WR_PTR_POS)
